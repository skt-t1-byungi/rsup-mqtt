...
EventEmitter.prototype.once = function once (name, listener) {
    var this$1 = this;
...
EventEmitter.prototype.off = function off (name, listener) {
  ...
  if (listener) {
    this._listeners[name] = (this._listeners[name] || []).filter(function (fn) { return fn !== listener; });
  } else {
...
var Message = function Message(pahoMessage) {
...
Client.prototype._handleOnMessage = function _handleOnMessage (pahoMessage) {
